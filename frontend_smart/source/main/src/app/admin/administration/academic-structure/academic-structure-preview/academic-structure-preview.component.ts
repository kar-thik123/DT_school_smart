...
@Component({
  selector: 'app-academic-structure-preview',
  standalone: true,
  imports: [CommonModule, FormsModule, MatIconModule, MatButtonModule, MatTooltipModule, MatPaginatorModule],
  templateUrl: './academic-structure-preview.component.html',
  styleUrl: './academic-structure-preview.component.scss',
})
export class AcademicStructurePreviewComponent {
