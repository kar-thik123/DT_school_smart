...
import { StudentPerformanceSummaryComponent } from '@shared/components/student-performance-summary/student-performance-summary.component';
...
@Component({
  ...
  imports: [
    ...
    StudentPerformanceSummaryComponent,
  ],
})
