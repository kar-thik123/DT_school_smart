...
export const PERMISSION_REGISTRY = {
  ...
  TEACHER_ASSIGNMENT: ['VIEW', 'CREATE', 'EDIT', 'DELETE'],
  ...
  STAFF_ATTENDANCE: ['VIEW', 'MANAGE'],
  EXAMINATION: ['VIEW', 'MANAGE'],
  STUDENT_EXAM_RESULT: ['VIEW', 'MANAGE'],
...
export const PERMISSION_DOMAINS: Record<string, 'PLATFORM' | 'TENANT'> = {
  ...
  ATTENDANCE: 'TENANT',
  STAFF_ATTENDANCE: 'TENANT',
  EXAMINATION: 'TENANT',
  STUDENT_EXAM_RESULT: 'TENANT'
};
